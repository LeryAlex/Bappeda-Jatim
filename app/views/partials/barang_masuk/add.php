                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-jumlah_unit_masuk"  value="<?php  echo $this->set_field_value('jumlah_unit_masuk',""); ?>" type="text" placeholder="Enter Jumlah Unit Masuk"  required="" name="jumlah_unit_masuk"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
