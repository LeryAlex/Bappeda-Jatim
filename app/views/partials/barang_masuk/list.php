                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-jumlah_unit_masuk"> Jumlah Unit Masuk</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            $rec_id = (!empty($data['id_nomor_masuk']) ? urlencode($data['id_nomor_masuk']) : null);
                                            $counter++;
                                            ?>
                                            <tr>
                                                <?php if($can_delete){ ?>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_nomor_masuk'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <?php } ?>
                                                    ...
                                                    <td class="td-nama">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['nama']; ?>" 
                                                            data-pk="<?php echo $data['id_nomor_masuk'] ?>" 
                                                            data-url="<?php print_link("barang_masuk/editfield/" . urlencode($data['id_nomor_masuk'])); ?>" 
                                                            data-name="nama" 
                                                    ...
                                                    <td class="td-kode_bidang">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/barang_masuk_kode_bidang_option_list'); ?>' 
                                                    ...
                                                    <td class="td-satuan">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/barang_masuk_satuan_option_list'); ?>' 
                                                    ...
                                                    <td class="td-jumlah_unit_masuk">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['jumlah_unit_masuk']; ?>" 
                                                            data-pk="<?php echo $data['id_nomor_masuk'] ?>" 
                                                            data-url="<?php print_link("barang_masuk/editfield/" . urlencode($data['id_nomor_masuk'])); ?>" 
                                                            data-name="jumlah_unit_masuk" 
                                                            data-title="Enter Jumlah Unit Masuk" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['jumlah_unit_masuk']; ?> 
                                                        </span>
                                                    </td>
                                                    <th class="td-btn">
                                                        <?php if($can_edit){ ?>
