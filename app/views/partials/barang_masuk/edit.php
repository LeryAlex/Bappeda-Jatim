                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-kode_bidang" name="kode_bidang"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        <?php
                                                        $rec = $data['kode_bidang'];
                                                        $kode_bidang_options = $comp_model -> barang_masuk_kode_bidang_option_list();
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-satuan" name="satuan"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                <?php
                                                                $rec = $data['satuan'];
                                                                $satuan_options = $comp_model -> barang_masuk_satuan_option_list();
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="jumlah_unit_masuk">Jumlah Unit Masuk <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-jumlah_unit_masuk"  value="<?php  echo $data['jumlah_unit_masuk']; ?>" type="text" placeholder="Enter Jumlah Unit Masuk"  required="" name="jumlah_unit_masuk"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
