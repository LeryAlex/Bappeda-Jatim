                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_nomor_masuk">
                                        <th class="title"> Id Nomor Masuk: </th>
                                        <td class="value"> <?php echo $data['id_nomor_masuk']; ?></td>
                                    </tr>
                                    <tr  class="td-nama">
                                    ...
                                    <tr  class="td-jumlah_unit_masuk">
                                        <th class="title"> Jumlah Unit Masuk: </th>
                                        <td class="value">
